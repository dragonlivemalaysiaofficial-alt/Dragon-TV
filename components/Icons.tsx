...
export const ComingIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const StarIcon: React.FC<{ filled: boolean, className?: string }> = ({ filled, className = 'h-4 w-4' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${className} ${filled ? 'text-yellow-400' : 'text-gray-500'}`} viewBox="0 0 20 20" fill={filled ? 'currentColor' : 'none'} stroke="currentColor">
...
export const LanguageIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5h12M9 3v2m1.06 7.94a1 1 0 00-1.414 0l-4 4a1 1 0 101.414 1.414L8 14.414V17a1 1 0 102 0v-2.586l1.293-1.293a1 1 0 000-1.414zM11 7.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
...
export const VersionIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h5M4 12h16M4 20h16m-5-4v4m0-10v4m-5-4v4" /></svg>
);
...
export const PlayIcon: React.FC<{ className?: string }> = ({ className = "h-12 w-12" }) => (
...
export const BellIcon: React.FC<{ filled?: boolean }> = ({ filled }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill={filled ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
...
export const MyListIcon: React.FC = () => (
